<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Despesas01.aspx.cs" Inherits="Orcamento.Escritorio.Despesas.Despesas01" %>
...
<asp:Label ID="lblCliente" runat="server" Text="" Visible="false"></asp:Label>
    ...
    <div class="col-12 text-left" style="margin-top:5px"></div>
        <div class="card-body">
            <asp:Label ID="Label1" runat="server" Text="Filtrar Por Despesas"></asp:Label>
            <asp:DropDownList ID="ddlDespesas" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlDespesas_SelectedIndexChanged"></asp:DropDownList>
            <div>
