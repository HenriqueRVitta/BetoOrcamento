<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Despesas06.aspx.cs" Inherits="Orcamento.Escritorio.Despesas.Despesas06" %>
...
<div class="panel" id="Despesas">
        ...
        <asp:Label ID="lblTotal" runat="server" Text="" Visible="false"></asp:Label>
            <div class="card text-left" style="background-color:#000438">
                    <div class="card-header text-center">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm" style="color:white">
                                <asp:Label ID="lblDespesa1" runat="server" Text="Label"></asp:Label>
                            </div>
                             <div class="col-sm" style="color:white">
                                <asp:Label ID="lblDespesa2" runat="server" Text="Label"></asp:Label>
                            </div>
                             <div class="col-sm" style="color:white">
                                <asp:Label ID="lblDespesa3" runat="server" Text="Label"></asp:Label>
                            </div>
                             <div class="col-sm" style="color:white">
                                <asp:Label ID="lblDespesa4" runat="server" Text="Label"></asp:Label>
                            </div>
                             <div class="col-sm" style="color:white">
                                <asp:Label ID="lblDespesa5" runat="server" Text="Label"></asp:Label>
                            </div>
                            <div class="col-sm" style="color:red">
                                <asp:Label ID="lblDespesa6" runat="server" Text="Label"></asp:Label>
                            </div>
                            <div class="col-sm">
                            </div>
                            <div class="col-sm">
            ...
            <div class="container">
                ...
                <div class="col-sm">
                    <asp:Button ID="BtnAvanca" runat="server" Text="Gravar" style="background-color:#000438; color:white" class="btn btn-primary" OnClick="BtnAvanca_Click"/>
                </div>
                </div>
            </div>
    </div>
