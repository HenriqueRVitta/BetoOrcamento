...
namespace Orcamento.Cadastros.Profissional
{
    public partial class Excluir : System.Web.UI.Page
    {
        ...
        protected void btExcluir_Click(object sender, EventArgs e)
        {
            ...
            string Del = "delete from tb_profissional where pr_id=@id";
            ...
            {
                ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "Mensagem", "alert('Erro no Update de Tipo de Profissional.');", true);
            }
            finally
            {
                qryDelete.Dispose();
