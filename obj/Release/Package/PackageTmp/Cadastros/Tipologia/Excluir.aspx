                            ...
                            <div class="panel-container show">
                                <div class="panel-content">
                                    ...
                                    <div class="form-group col-md-8 offset-md-2 col-xl-6 offset-xl-3" style="margin-top: 10px;">
                                        ...
                                        <asp:HyperLink NavigateUrl="/Cadastros/Tipificação/Lista" runat="server" asp-route-id="@ti_id" title="Voltar para o pesquisa" class="btn btn-secondary btnSecundary">Voltar</asp:HyperLink>
                                    </div>
                                </div>
                            </div>
                        </div>
