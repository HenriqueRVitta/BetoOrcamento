    ...
    public partial class Cadastro : System.Web.UI.Page
    {
        ...
        protected void btnSalvar_Click(object sender, System.EventArgs e)
        {
            if (id==0)
            {
                ...
                qryInsert.Parameters.Add("@margem_lucro", MySqlDbType.Decimal).Value = Convert.ToDecimal(pr_margem_lucro.Text);
            ...
            else
            {
                ...
                qryUpdate.Parameters.Add("@margem_lucro", MySqlDbType.Decimal).Value = Convert.ToDecimal(pr_margem_lucro.Text);
                qryUpdate.Parameters.Add("@margem_dificuldade", MySqlDbType.Decimal).Value = Convert.ToDecimal(pr_margem_dificuldade.Text);
