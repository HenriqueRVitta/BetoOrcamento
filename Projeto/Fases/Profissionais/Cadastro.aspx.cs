    ...
    public partial class Cadastro : System.Web.UI.Page
    {
        ...
        protected void btnSalvar_Click(object sender, System.EventArgs e)
        {
            if (id==0)
            {
                ...
                string Ins = "insert INTO tb_projeto_profissional(pp_projeto,pp_profissional,pp_valor,pp_quantidade) values(@projeto,@profissional,@valor,@quantidade)";
            ...
            else
            {
                ...
                string Upd = "update tb_projeto_profissional set pp_profissional=@profissional,pp_valor=@valor,pp_quantidade=@quantidade where pp_id=@id";
